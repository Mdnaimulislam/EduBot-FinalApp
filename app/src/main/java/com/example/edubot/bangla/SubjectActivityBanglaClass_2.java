...
public class SubjectActivityBanglaClass_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bangla_sub=(Button)findViewById(R.id.bangla_bn_2);
        english_sub=(Button)findViewById(R.id.english_bn_2);
        math_sub=(Button)findViewById(R.id.math_bn_2);


        bangla_sub.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(SubjectActivityBanglaClass_2.this,BanglaChapterClass2ActivityBangla.class));
            }
        });
        english_sub.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(SubjectActivityBanglaClass_2.this,EnglishChapterClass2ActivityBangla.class));
            }
        });
