...
public class WebBanglaActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    private WebView webviewbangla;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_web_bangla);
        ...
        toolbar.setTitle("রোবটেক ভ্যালী ওয়েবসাইট");
