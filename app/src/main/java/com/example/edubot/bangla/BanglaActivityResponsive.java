...
public class BanglaActivityResponsive extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,TextToSpeech.OnInitListener {
    private ToggleButton talk;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bangla_responsive);
        //mute audio
        ...
        talk=(ToggleButton)findViewById(R.id.bangla_talk_btn_responsive);
        Manual=(Button)findViewById(R.id.Manual);
        Manual.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(x==0) {
                    startActivity(new Intent(BanglaActivityResponsive.this, BanglaActivityManual.class));
                }
                else{
                    Toast.makeText(BanglaActivityResponsive.this,"কথা বলা বন্ধ করো।",Toast.LENGTH_LONG).show();
                }
            }
        });
