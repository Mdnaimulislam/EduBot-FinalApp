...
public class BanglaChapterClass1ActivityEnglish extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                    ...
                    startActivity(new Intent(BanglaChapterClass1ActivityEnglish.this, SubjectActivityEnglishClass_1.class));
