...
public class BanglaChapterClass2ActivityEnglish extends AppCompatActivity implements TextToSpeech.OnInitListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(BanglaChapterClass2ActivityEnglish.this, SubjectActivityEnglishClass_2.class));
            }
        });
