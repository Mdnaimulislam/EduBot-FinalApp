...
public class BanglaChapterClass5ActivityEnglish extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(BanglaChapterClass5ActivityEnglish.this, SubjectActivityEnglishClass_5.class));
            }
        });
