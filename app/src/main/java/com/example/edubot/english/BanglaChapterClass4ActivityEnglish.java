...
public class BanglaChapterClass4ActivityEnglish extends AppCompatActivity implements TextToSpeech.OnInitListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(BanglaChapterClass4ActivityEnglish.this, SubjectActivityEnglishClass_4.class));
            }
        });
